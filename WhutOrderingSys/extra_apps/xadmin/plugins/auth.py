...
class UserAdmin(object):
    ...
    list_display = ('username', 'email', 'name', 'gender', 'phone', 'student_code', 'address', 'is_staff')
    list_filter = ('is_staff', 'is_superuser','username', 'name', 'student_code', 'email', 'gender', 'address')
    search_fields = ('username', 'name', 'student_code', 'email', 'gender', 'address')
    ordering = ('username',)
